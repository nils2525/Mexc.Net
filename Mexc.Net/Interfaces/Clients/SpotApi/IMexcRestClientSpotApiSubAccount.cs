...
namespace Mexc.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IMexcRestClientSpotApiSubAccount
    {
        ...
        /// <returns></returns>
        Task<WebCallResult<MexcSubUserAccounts>> GetSubUserAccountsAsync(string? name = null, bool? isFreeze = null, int? page = null, int? limit = null, CancellationToken ct = default);
        ...
        /// <param name="fromAccountType">The origin acount type</param>
